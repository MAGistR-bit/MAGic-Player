...
## 🛠️ Тестирование мобильного приложения
Для тестирования пользовательского интерфейса
Android-приложения использовался фреймворк Espresso.

Тесты для музыкального проигрывателя располагаются по следующему пути: _**app/src/androidTest/java/com/example/projectMP3**_
